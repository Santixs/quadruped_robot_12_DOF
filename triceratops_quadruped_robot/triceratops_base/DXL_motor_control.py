...
class DXL_Communication(object):
    def __init__(self, device_name = '/dev/ttyUSB0', b_rate=57600, log_level="info", log_file_level="debug"):
        #b_rate=3000000
...
def MotorReadTest(DEVICE_NAME, B_RATE):
    #show difference between optimized SDK and original SDK
...
if __name__ == "__main__":
    ...
    # SingleMotorTest()
    # haodergghada
    MotorReadTest(DEVICE_NAME,B_RATE)